      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-3">
            ...
            <a
              href="https://github.com/MohammedAbo-Bakr"
              target="_blank" rel="noreferrer"
              className="flex items-center gap-4 p-4 rounded-lg border border-border bg-card/60 hover:border-primary/50 transition"
            >
              <div className="w-10 h-10 min-w-[40px] rounded-md bg-primary/10 text-primary flex items-center justify-center">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div>
                <div className="font-mono text-[10px] text-muted-foreground uppercase tracking-wider">GitHub</div>
                <div className="text-sm break-all sm:break-normal">github.com/MohammedAbo-Bakr</div>
              </div>
            </a>
